...
if pivot in content and "@app.route('/compare_futures" not in content:
    content = content.replace(pivot, endpoints_code + "\n" + pivot)
    with open(filepath, 'w', encoding='utf-8') as f:
        f.write(content)
    print("Backend endpoints comparison appended perfectly.")
else:
    print("Backend endpoints already appended or pivot not found.")
